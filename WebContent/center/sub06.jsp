		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<div class="con_box">
					...
					<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=3ab59321e5d241ea14684f86c291cf8d" ></script>
					<script>
				...
				// 마커가 표시될 위치입니다 
				var markerPosition  = new kakao.maps.LatLng(37.574437, 126.889911); 
