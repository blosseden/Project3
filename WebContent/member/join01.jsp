		...
		<div class="contents_box">
			...
			<form name="registFrm" id="registFrm" method="post">
				<p style="text-align:center; margin-bottom:20px;"><input type="checkbox" name="agreement1" value="">이용약관과 개인정보취급방침에 동의합니다.</p>
					<!-- 체크 -->
				<p style="text-align:center; margin-bottom:20px"><img id="agreement2" src="../images/btn01.gif" />&nbsp;&nbsp;<a href="http://www.ikosmo.co.kr"><img src="../images/btn02.gif" /></a></p>
			</form>
<script>
	$(function(){
		...
		$('#agreement2').click(function(){ 
			...
			if($("input:checkbox[name='agreement1']").is(':checked')==true){
